...
opAdd 1 first second to = []

opMultiply :: Int -> Int -> Int -> Int -> [Int]
opMultiply 2 first second to = []

opNoop :: Int -> Int -> Int -> Int -> [Int]
opNoop 99 _ _ _ = []
...
top' :: [Int] -> [Int]
top' (1 : first : second : to : tail) = [] 
top' (2 : first : second : to : tail) = [] 
top' (99 : tail) = [] 
top' _ = []
